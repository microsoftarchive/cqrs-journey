...
These release notes apply to the Reference Implementation – Contoso Conference Management System. This RI complements the [”Exploring CQRS and Event Sourcing” guide](http://go.microsoft.com/fwlink/p/?LinkID=258572) and is for learning purposes only.
...
> the releases are referred to as ‘pseudo-production’ because they lack critical security 
