...
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[{0}].[Messages]') AND type in (N'U'))
CREATE TABLE [{0}].[Messages](
    [Id] [bigint] IDENTITY(1,1) NOT NULL,
    [Body] [nvarchar](max) NOT NULL,
    [DeliveryDate] [datetime] NULL,
 CONSTRAINT [PK_{0}.Messages] PRIMARY KEY CLUSTERED 
(
    [Id] ASC
