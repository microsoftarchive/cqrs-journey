...
namespace Registration.ReadModel.Implementation
{
    ...
    public class ConferenceRegistrationDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<DraftOrder>().HasMany(c => c.Lines).WithRequired().Map(c => c.MapKey("OrderDTO_OrderId"));
            modelBuilder.Entity<DraftOrderItem>().ToTable("OrderItemsView", SchemaName);
            modelBuilder.Entity<PricedOrder>().ToTable("TotalledOrders", SchemaName);
            ...
            modelBuilder.Entity<Conference>().HasMany(c => c.Seats).WithRequired().Map(c => c.MapKey("ConferencesView_Id"));
            modelBuilder.Entity<SeatType>().ToTable("ConferenceSeatsView", SchemaName);
        }
